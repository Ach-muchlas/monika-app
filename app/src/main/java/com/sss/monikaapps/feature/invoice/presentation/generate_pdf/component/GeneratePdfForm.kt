package com.sss.monikaapps.feature.invoice.presentation.generate_pdf.component
...
fun GeneratePdfForm(
    ...
    Column(
        ...
        Text(
            text = "Form Generate PDF Laporan Tagihan",
        ...
        CustomTextField(
            ...
            onValueChange = {},
            hint = "Pilih tanggal hasil tagihan",
            readOnly = true,
            leadingIcon = {
                Icon(
