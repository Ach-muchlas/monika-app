...
@Composable
fun CardDetailItemExpanse(
    typeExpanse: String,
    netAmount: String,
    isRequiredKm: Boolean,
        ...
        Row(
            ...
            Column(
                ...
                Row(
                    ...
                    Text(formatCurrency(amount = netAmount.toLong()), style = BodyPopSemiBold)
                    Text(
                        typeExpanse,
                ...
                if (isRequiredKm) {
                    Text(
                        "${formatCurrencyWithoutRp(initialKilometer.toLong())} - ${
                            formatCurrencyWithoutRp(
                                finalKilometer.toLong()
                            )
