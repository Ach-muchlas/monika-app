...
class VisitDetailViewModel(
    ...
    private val _visitDetailResult = MutableLiveData<Result<DataItemDetailVisitLocal>>()
    val visitDetailResult: LiveData<Result<DataItemDetailVisitLocal>> = _visitDetailResult
