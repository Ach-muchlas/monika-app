package com.sss.monikaapps.feature.visit.presentation.detail.component
...
fun CardHeaderVisitDetail(
    ...
    Card(
        ...
        Column(
            ...
            Text(customerId, style = TitlePopBold.copy(color = Primary))
            Spacer(modifier = Modifier.height(Dimens.ExtraSmallMargin))
            Text(customerName, style = BodyPopSemiBold)
            Spacer(modifier = Modifier.height(4.dp))
            Text(address, style = BodyBitterMedium.copy(fontSize = Dimens.MediumFont, color = Gray))
            ...
            Row(
                ...
                Text("$latitude - $longitude", style = BodyPopRegular.copy(fontSize = 14.sp))
            }
            Spacer(modifier = Modifier.height(Dimens.ExtraSmallMargin))
            Row(
                verticalAlignment = Alignment.CenterVertically
